...
from blog.views import addStar
from comments.views import  deleteComment, showComments
...
urlpatterns = [
    ...
    path('comments/<int:id>',showComments,name='showcomments'),
    path('comment/delete/<int:id>',deleteComment,name='deletecomment'),
    path('addstar/',addStar,name='addstar')
